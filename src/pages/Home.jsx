      ...
      <div className="container h-full hidden lg:flex ">
        ...
        <div className="navs h-full flex flex-col gap-6 items-start p-20 justify-center lg:ml-24  relative">
          <motion.h1
            ...
            {...DivAHoveringProps}
            className=" text-6xl lg:text-9xl scale-110 relative z-20 font-bold hover:translate-x-12 transition ease-in-out duration-200 cursor-pointer group  "
          >
          ...
          <motion.h1
            ...
            transition={{ duration: 1 }}
            {...DivBHoveringProps}
            className=" text-6xl lg:text-9xl scale-110 relative z-20 font-bold hover:translate-x-12 transition ease-in-out duration-200 cursor-pointer group  text-red-600"
          >
